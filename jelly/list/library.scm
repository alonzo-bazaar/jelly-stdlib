...
(define-library (jelly list library)
  (import (jelly list base)
          (only (jelly functional) complement))
...
;;; These cannot meaningfully be n-ary.
    ...
    (define (delete-duplicates lis &rest maybe-=)
    ...
    (define (alist-delete key alist &rest maybe-=)
      (let ((= (optional maybe-= equal?)))
